export const starters = [
  ...
  },
  {
    ...
    instructions: [
      ...
      "Wrap the salmon in a double layer of greaseproof paper, then wrap it tightly with clingfilm and place it in the fridge overnight. Check on it the next day, spooning any cure that has slipped off back over the salmon, then re-wrap it and place back in the fridge for one more night.",
      "On the third day, take the salmon out of the fridge and carefully unwrap it so you can rinse off the cure.",
      "Use a spoon to gently push the blackberry cure off the fish, then gently rinse off the residual cure with about 100ml of cold water, pouring a splash at a time over your salmon. Put the salmon to one side and rinse the tray under the tap.",
      "For the herb cure, pick and finely chop the dill and tarragon, then mix with the sloe gin in a bowl.",
  ...
  },
  {
    ...
    instructions: [
      ...
      "Slice, then place the squid in the marinade, cover with clingfilm and marinate for 3 to 4 hours in the fridge. Preheat a barbecue or cast-iron griddle pan to a medium heat.",
  ...
  },
  {
    ...
    instructions: [
      ...
      "Soak the dried apricots in boiling water and set aside.",
  ...
  },
  {
    ...
    instructions: [
      ...
      "Lower the eggs into a pan of vigorously simmering water and boil for 5½ minutes for soft-boiled, or to your liking, then refresh under cold water until cool enough to handle, and peel.",
      "Crumble the Stilton into a large jug. Finely chop and add the chives, along with a drizzle of extra virgin olive oil. Squeeze in the lemon juice and add the remaining dressing ingredients. Whisk well, season to taste with salt and pepper, then pop in the fridge until needed.",
  ...
  },
  {
    ...
    ingredients: [
      ...
      "1 x 200 g yellowfin tuna steak, sustainably sourced",
      "1 lemon",
      "½ a bunch of fresh basil",
      "½ a bunch of fresh dill",
      "1 small clove of garlic",
  ...
  },
  {
    ...
    ingredients: [
      ...
      "100 g white crabmeat , from sustainable sources",
      "1-2 teaspoons aji amarillo paste , or piri piri sauce",
      "100 g plain flour",
      "2 large free-range eggs",
      "100 g breadcrumbs",
      "1 litre vegetable oil",
  ...
  },
  {
    ...
    instructions: [
      ...
      "Fry on a medium heat until the bacon is golden and crisp, the onion is sticky and soft and the Jerusalem artichokes have sucked up all the flavours and turned crispy. The important thing to remember here is that you need enough colour, but not so much that you’re on the edge of burning everything.",
  ...
  },
  {
    ...
    instructions: [
      ...
      "Heat the oil. To check whether it’s hot enough for frying, drop in the piece of potato – as soon as it sizzles and floats to the top, you’re in business. Remove the potato and discard it.",
  ...
  },
  {
    ...
    ingredients: [
      ...
      "1 teaspoon ground coriander",
      "½ teaspoon dried mango powder , (see tip)",
      "4 long or 2 small classic aubergines",
      "sunflower oil",
      "15 curry leaves",
      "CORIANDER CHUTNEY",
      "1 lime",
