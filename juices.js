export const juices = [
  {
    name: "Fruity slushy",
    subName: "A refreshing soft drink",
    specialDiets: ["Vegetarian", "Vegan", "Gluten-free", "Dairy-free"],
    metaDescription:
      "Jamie's fruity slushy is super quick to whiz together and the perfect refreshing drink to make with kids on a sunny day.",
    description: "",
    servings: "8",
    time: {
      prep: "",
    ...
    instructions: [
      ...
      "Start with one fruit and blend with a handful of ice cubes until smooth.",
      "Pour equal amounts into suitable glasses then repeat with the remaining fruits, pouring over the top of the previous fruit slushie to create layers of colour and flavour.",
      "You can add a little cold water if you like it slightly runnier.",
      "Serve the slushie with paper straws and any other decorations you fancy.",
    ],
    image: "https://cdn.jamieoliver.com/recipe-database/medium/135798307.jpg",
    imageAlt: "Fruity slushy",
  },
  {
    name: "Super green smoothie",
    subName: "Banana, apple & baby spinach",
    specialDiets: ["Vegetarian"],
    metaDescription:
      "This tasty green juice gives us a total balanced brekkie, all in one nice, big glass. ",
    description:
      "“This tasty green smoothie gives us a total balanced brekkie, all in one nice, big glass. ”",
    servings: "2",
    time: {
      prep: "",
      cook: "5 minutes",
    ...
    tags: ["Super Food Family Classics", "Breakfast", "Juices and smoothies"],
    ingredients: [
      "1 ripe banana",
      "1 apple",
      "80 g baby spinach",
    ...
    instructions: [
      "Peel the banana and place in a blender with the apple (discard the stalk and core), spinach, oats, milk and your chosen nut butter.",
      "Add 1 handful of ice cubes and blitz until smooth, loosening with splashes of water until you get the perfect drinkable consistency.",
      "Pour into 2 big glasses or decant into bottles and enjoy.",
    ],
    image: "https://cdn.jamieoliver.com/recipe-database/medium/134625398.jpg",
    imageAlt: "Super green smoothie",
  },
  {
  ...
  {
    name: "Pomegranate, ginger & lime flavoured water",
    subName: "Colourful, bright & delicious",
    specialDiets: ["Dairy-free", "Gluten-free", "Vegan", "Vegetarian"],
    metaDescription:
    ...
    description:
      "“A quick and easy way to make staying hydrated totally tasty. ”",
    servings: "Serves Makes 1 jug",
    time: {
      prep: "",
      cook: "",
      active: "",
    ...
    image:
      "https://cdn.jamieoliver.com/recipe-database/oldImages/medium/1601_9_1440751230.jpg",
    imageAlt: "Pomegranate, ginger & lime flavoured water",
  },
  {
  ...
  {
    name: "Mango cooler",
    subName: "Great with spicy food",
    specialDiets: ["Gluten-free", "Vegetarian"],
    metaDescription:
      "Rustle up this mango smoothie recipe for a refreshing treat on a hot summer's day; the kids will love this mango smoothie with milk, mint and lime too!",
    description:
      "“Made with juicy mango and fresh mint, this delicious drink is instantly cooling and refreshing. ”",
    servings: "4",
    time: {
      prep: "",
      cook: "5 minutes",
    ...
    difficulty: "Super easy",
    tags: ["Fruit", "Juices and smoothies"],
    ingredients: [
    ...
    instructions: [
      "Remove the skin and cut the juicy flesh off the mangos, then place in a blender or food processor, along with any juice left on the chopping board.",
      "Pour in the milk, finely grate in the lime zest and squeeze in the juice.",
      "Add 1 handful of ice cubes, then pick in the mint leaves and blitz until smooth.",
      "Taste, and add a little honey, if needed, then give it another quick blitz, before pouring into glasses and serving.",
    ],
    image:
      "https://cdn.jamieoliver.com/recipe-database/oldImages/medium/328_1_1436864467.jpg",
    imageAlt: "Mango cooler",
  },
  {
    name: "Fruit smoothie",
